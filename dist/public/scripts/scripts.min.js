...
$(document).ready(function(){modal.init(),comments.init()});var modal={init:function(){this.cacheDom(),this.bindEvents()},reInit:function(){},cacheDom:function(){this.$openTriggers=$(".js-open-modal"),this.$closeTriggers=$(".js-close-modal"),this.$copyTriggers=$(".js-copy-url")},bindEvents:function(){this.$openTriggers.on("click",function(i){i.preventDefault();var s=($(this).data("target"),$(this).data("type")),t=$("#modal-"+s);t.addClass("is-visible")}),this.$closeTriggers.on("click",function(i){i.preventDefault(),$(this).closest(".m-modal").removeClass("is-visible")}),this.$copyTriggers.on("click",function(i){i.preventDefault(),$(this).siblings(".js-page-url").focus().select(),document.execCommand("copy");var s=$(this).find(".m-modal__copied");s.addClass("is-visible"),window.setTimeout(function(){s.removeClass("is-visible")},5e3)})}},comments={init:function(){this.cacheDom(),this.bindEvents()},reInit:function(){},cacheDom:function(){this.$commentTriggers=$(".js-show-comments")},bindEvents:function(){this.$commentTriggers.on("click",function(i){i.preventDefault();var s=$(this).data("target");$("#comments-"+s).addClass("is-visible"),$(this).remove()})}};
