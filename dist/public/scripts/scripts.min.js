...
$(document).ready(function(){modal.init(),comments.init()});var modal={init:function(){this.cacheDom(),this.bindEvents()},reInit:function(){},cacheDom:function(){this.$openTriggers=$(".js-open-modal"),this.$closeTriggers=$(".js-close-modal")},bindEvents:function(){this.$openTriggers.on("click",function(i){i.preventDefault();var t=$(this).data("target"),n=($(this).data("type"),$("#modal-"+t));n.addClass("is-visible")}),this.$closeTriggers.on("click",function(i){i.preventDefault(),$(this).closest(".m-modal").removeClass("is-visible")})}},comments={init:function(){this.cacheDom(),this.bindEvents()},reInit:function(){},cacheDom:function(){this.$commentTriggers=$(".js-show-comments")},bindEvents:function(){this.$commentTriggers.on("click",function(i){i.preventDefault();var t=$(this).data("target");$("#comments-"+t).addClass("is-visible")})}};
